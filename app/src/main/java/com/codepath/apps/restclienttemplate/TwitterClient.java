...
public class TwitterClient extends OAuthBaseClient {
    ...
    public static final String REST_CONSUMER_KEY = "1HnQS2eBEOmnI51l9VzPL6fEj";
  public static final String REST_CONSUMER_SECRET = "EyEmviJScyuKxMfkXZPJCKND2NoZGjpsp3qavshzXNjNr9E5h3";
